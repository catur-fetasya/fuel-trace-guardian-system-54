		...
		<div class="col-md-12">
			...
			<div class="box box-info">
				<div class="box-header with-border">
					<h3 class="box-title">Tambah Setoran Tabungan</h3>
...
<?php
    ...
    if ($query_simpan) {
        echo "<script>
        Swal.fire({title: 'Setoran Tabungan Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
        }).then((result) => {
            if (result.value) {
        ...
        echo "<script>
        Swal.fire({title: 'Setoran Tabungan Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
        }).then((result) => {
            if (result.value) {
