<?php
    ...
    if(isset($_GET['kode'])){
        $sql_cek = "SELECT * FROM tb_spp WHERE no='".$_GET['kode']."'";
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="box-body">
						...
						<select name="jenis_spp" id="jenis_spp" class="form-control" required>
							...
							<option value="SPP REGULER" <?php if($data_cek['jenis_spp']=='SPP REGULER'){echo 'selected';} ?>>SPP REGULER</option>
							<option value="SPP PLUS" <?php if($data_cek['jenis_spp']=='SPP PLUS'){echo 'selected';} ?>>SPP PLUS</option>
						</select>
						</div>

                        <div class="form-group">
                            <label>Tahun SPP</label>
                            <input type="number" class="form-control" name="tahun_spp" value="<?php echo $data_cek['tahun_spp']; ?>" min="2000" max="2099" required/>
                        </div>
                        <div class="form-group">
